package com.micro.service.auth.repository.auth.impl;

/**
 * @description:
 * @author: yang.zhou
 * @version: 1.0.0
 * @since: 2016-10-13 4:52 PM
 */

import com.micro.service.auth.model.auth.OauthClientDetails;
import com.micro.service.auth.repository.auth.OauthRepository;
import com.micro.service.auth.repository.jdbc.OauthClientDetailsRowMapper;
...
import static com.micro.service.auth.constant.CacheConstants.CLIENT_DETAILS_CACHE;
