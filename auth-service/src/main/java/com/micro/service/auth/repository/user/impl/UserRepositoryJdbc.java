package com.micro.service.auth.repository.user.impl;

import com.micro.service.auth.model.user.Privilege;
import com.micro.service.auth.model.user.User;
import com.micro.service.auth.repository.jdbc.UserRowMapper;
import com.micro.service.auth.repository.user.UserRepository;
...
import static com.micro.service.auth.utils.CacheConstants.USER_CACHE;

/**
 * @description:
 * @author: yang.zhou
 * @version: 1.0.0
 * @since: 2016-10-13 5:54 PM
 */
